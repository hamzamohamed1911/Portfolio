...
const Contact = () => {
  ...
  <div className="  h-full px-8 mx-auto max-w-screen-md">
      <h2  className= {`font-sans  mb-10 text-6xl tracking-tight font-extrabold text-center ${dark ? " text-white" : "text-blue-900"} `}>Contact Us </h2>
      <p className= {`font-roboto font-light text-xl px-4 mb-10 lg:mb-16 text-center sm:text-xl${dark ? " text-white" : "text-blue-900"} `}>Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
      <form  ref={form} onSubmit={sendEmail} className="space-y-8">
        
          <div>
              <label htmlFor="email" className= {`block mb-3 text-sm font-medium${dark ? " text-white" : "text-blue-900"} `}>Your email</label>
          ...
          <div>
              <label htmlFor="subject" className= {`block mb-3 text-sm font-medium${dark ? " text-white" : "text-blue-900"} `}>Subject</label>
          ...
          <div className="sm:col-span-2">
              <label htmlFor="user_message" className= {`block mb-3 text-sm font-medium${dark ? " text-white" : "text-blue-900"} `}>Your message</label>
